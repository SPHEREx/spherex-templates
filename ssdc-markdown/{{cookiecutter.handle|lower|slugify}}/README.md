...
- [spherex-sphinx](https://github.com/SPHEREx/spherex-sphinx): *Configuration for SPHEREx Sphinx-based documents*
- [Technote](https://technote.lsst.io): *Core package for Sphinx-based documents, from Rubin Observatory*
- [MyST-Parser](https://myst-parser.readthedocs.io/en/latest/): *Syntax for Markdown and Jupyter Notebooks*
