...
This is the template for SSDC technical note document repositories (`TN` document category) written in LaTeX.
...
```shell
cookiecutter gh:SPHEREx/spherex-templates --directory ssdc-tn-latex
```
...
If the workflow succeeded, you can click through to it (e.g., https://github.com/IPAC-SW/ssdc-tn-009/actions/runs/) and you should see on the lower half of the page that there’s an “artifact” list which includes a PDF for the document.  The PDF name is the document handle plus the 7-digit “SHA” identifier for the commit from which it was generated.
...
You can see one here: https://github.com/IPAC-SW/ssdc-tn-009/releases.
